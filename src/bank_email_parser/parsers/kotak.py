...
class KotakStatementEmailParser(BaseEmailParser):
    ...
    Subject: "Your <Month-Year> statement for Kotak A/c X1234"
    Body announces the attached, password-protected statement PDF and
    explains the two password options: CRN or first-4-letters-of-name + DDMM.
    """
